...
urlpatterns = [
    ...
    path('comic-list-lowest-price/', comic_list_lowest_price_api_view, name="comic_list_lowest_price_api_view"),
    path('comic-list-highest-price/', comic_list_highest_price_api_view, name="comic_list_highest_price_api_view")
]
